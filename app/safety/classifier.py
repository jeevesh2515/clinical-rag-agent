...
GUIDELINE_PATTERNS = [
    ...
    for pattern in [
        ...
        r"acei|arb|ccb|diuretic",
        r"amlodipine|lisinopril|losartan|hydrochlorothiazide|chlorthalidone",
        r"chronic kidney|ckd",
        r"cardiovascular|ascvd",
        r"\b(nice|cdc|uspstf|aha|acc|nhs|cms|esh|esc|kdigo|jnc)\b",
